  ...
  return (
    <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.08] dark:opacity-[0.05] pointer-events-none">
        ...
        <div
          className="absolute top-0 left-0 w-full h-1/3 bg-cover bg-center pointer-events-none"
          style={{
        ...
        <div
          className="absolute top-1/3 right-0 w-1/2 h-1/3 bg-cover bg-center pointer-events-none"
          style={{
        ...
        <div
          className="absolute top-1/3 left-0 w-1/2 h-1/3 bg-cover bg-center pointer-events-none"
          style={{
        ...
        <div
          className="absolute bottom-1/3 right-0 w-full h-1/3 bg-cover bg-center pointer-events-none"
          style={{
        ...
        <div
          className="absolute bottom-0 left-1/4 w-1/2 h-1/4 bg-cover bg-center pointer-events-none"
          style={{
        ...
        <div
          className="absolute bottom-0 right-1/4 w-1/2 h-1/4 bg-cover bg-center pointer-events-none"
          style={{
      ...
      {/* Readability overlay gradient - also non-interactive */}
